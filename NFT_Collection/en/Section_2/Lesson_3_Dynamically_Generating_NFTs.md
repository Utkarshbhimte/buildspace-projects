...
------------------------
Encoding and decoding the tokenURI content to check the output image and metadata can be painful, to make it easier, you can use [this](https://nftpreview.0xdev.codes/) tool. You would just need to pass your finalTokenUri as a query parameter. 
